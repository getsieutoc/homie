...
const OrganizationCreateForm: React.FC<OrganizationFormType> = ({
  initialData,
  categories,
}) => {
  ...
  const title = initialData ? 'Edit product' : 'Organization';
  ...
  const processForm: SubmitHandler<OrganizationFormValues> = (data) => {
  ...
  type FieldName = keyof OrganizationFormValues;
